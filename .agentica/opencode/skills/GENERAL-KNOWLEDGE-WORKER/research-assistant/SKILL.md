...
For substantial parallel research or long-running build-plus-research work, use the background-session flow from `skills/agentica-system/sessions/SKILL.md`.
