...
### Shadows
- **Tone-match shadows to the surface.** The Agentica palette's `--shadow-sm`, `--shadow-md`, and `--shadow-lg` variables use a warm-tinted shadow color. Reference them directly:
  ```css
