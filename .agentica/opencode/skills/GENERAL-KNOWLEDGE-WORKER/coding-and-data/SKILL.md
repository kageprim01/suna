...
Prefer background sessions for substantial coding or data work. Read `skills/agentica-system/sessions/SKILL.md` and use `session_start_background` / `session_spawn`, then inspect results with `session_read`.
