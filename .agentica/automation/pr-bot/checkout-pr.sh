#!/usr/bin/env bash
# Clone kageprime/agentica and check out the PR head into a clean working dir,
# then print that dir on stdout. Authenticated with $GH_TOKEN.
#
# Usage:  WORKDIR=$(.agentica/automation/pr-bot/checkout-pr.sh)
#
...
# kageprime/agentica is public, so a tokenless clone reads fine. If GH_TOKEN
