...
Any repo with a valid `kortix.toml` at the root is an Agentica project.
...
| `kortix_cli` | What it may do to Agentica via the CLI/API (project-scoped iam actions). Same shape (default: none). |
