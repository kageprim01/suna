...
- "How do change requests work in Agentica?" / "What's `kortix cr`?"
...
<cli>
You are running inside an Agentica session sandbox. The **`kortix` CLI**
...
**Full reference:** `.kortix/opencode/skills/system/references/kortix/kortix-cli.md`
— every command, every flag, every env var, common workflows. Load it
when you need exact syntax.
</cli>

<change-requests>
**This is the single most important rule for any agent running in an
...
Full reference: `.kortix/opencode/skills/system/references/kortix/change-requests.md`.
</change-requests>
...
| ----------------- | -------- | ---------------------------------------------------------- | -------------------------------- |
| Agentica config   | Agentica | `kortix.toml` + `.kortix/Dockerfile`                       | The Agentica platform            |
| OpenCode config   | OpenCode | `.kortix/opencode/opencode.jsonc` + everything beside it   | OpenCode (local + sandbox); Agentica may inspect metadata for server-side agent/model UI surfaces |

The location of OpenCode's config dir is declared in `kortix.toml` under `[opencode] config_dir` — the default is `.kortix/opencode`. Relocate only if you want to share one OpenCode config across multiple Agentica repos.
...
kortix_cli = ["project.deploy", "project.cr.open"]   # what it may do via the Agentica CLI/API (default: none)
```
...
| **`connectors`** (integration access) + **`kortix_cli`** (Agentica CLI/API powers) | **`kortix.toml` `[[agents]]`** |
...
<reference path=".kortix/opencode/skills/system/references/kortix/credentials-and-setup-links.md">
...
<reference path=".kortix/opencode/skills/system/references/kortix/kortix-cli.md">
...
<reference path=".kortix/opencode/skills/system/references/kortix/kortix-toml.md">
...
<reference path=".kortix/opencode/skills/system/references/kortix/change-requests.md">
...
<reference path=".kortix/opencode/skills/system/references/opencode/overview.md">
  How OpenCode fits into an Agentica project — where each primitive lives
...
<reference path=".kortix/opencode/skills/system/references/opencode/agents.md">
...
<reference path=".kortix/opencode/skills/system/references/opencode/skills.md">
  On-demand `SKILL.md` definitions. Discovery paths, frontmatter rules,
  name validation, permission gating. Mirrored from
  <https://opencode.ai/docs/skills/>.
</reference>

<reference path=".kortix/opencode/skills/system/references/opencode/commands.md">
...
<reference path=".kortix/opencode/skills/system/references/opencode/tools.md">
...
<reference path=".kortix/opencode/skills/system/references/opencode/plugins.md">
...
<reference path=".kortix/opencode/skills/system/references/opencode/mcp-servers.md">
...
<reference path=".kortix/opencode/skills/system/references/opencode/permissions.md">
...
<reference path=".kortix/opencode/skills/system/references/opencode/rules.md">
...
<reference path=".kortix/opencode/skills/system/references/opencode/models.md">
...
- **The workspace IS global — sessions are not.** An Agentica project is
...
- **Triggers live in `kortix.toml`, not as files.** Old Agentica shipped
  triggers under `.opencode/triggers/<slug>.md` — that's gone.
  Centralized in the manifest now, parsed as `[[triggers]]`.
- **Agentica-owned files live in `.kortix/` at the repo root.** The
