 ...
 * primary `pnpm dev` (ports 3000/8008/5432x, project `agentica-local`) is never
 * touched.
 *
 * State lives entirely under $AGENTICA_HOME (default ~/.agentica), OUTSIDE any
