...
/** E2B volume discount placeholder — set to negotiated rate when E2B pricing is
 *  finalized. Same structure as DAYTONA_DISCOUNT for consistency. */
export const E2B_DISCOUNT = 1.0;
