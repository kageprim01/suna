...
const BASE_STARTER_PATHS = [
  ...
  '.kortix/opencode/skills/computer/SKILL.md',
  '.kortix/opencode/skills/executor/references/executor-sdk.md',
  '.kortix/opencode/skills/executor/SKILL.md',
  '.kortix/opencode/skills/memory/SKILL.md',
  '.kortix/opencode/skills/slack/SKILL.md',
  '.kortix/opencode/skills/system/references/kortix/change-requests.md',
  '.kortix/opencode/skills/system/references/kortix/credentials-and-setup-links.md',
  '.kortix/opencode/skills/system/references/kortix/kortix-cli.md',
  '.kortix/opencode/skills/system/references/kortix/kortix-toml.md',
  '.kortix/opencode/skills/system/references/opencode/agents.md',
  '.kortix/opencode/skills/system/references/opencode/commands.md',
  '.kortix/opencode/skills/system/references/opencode/mcp-servers.md',
  '.kortix/opencode/skills/system/references/opencode/models.md',
  '.kortix/opencode/skills/system/references/opencode/overview.md',
  '.kortix/opencode/skills/system/references/opencode/permissions.md',
  '.kortix/opencode/skills/system/references/opencode/plugins.md',
  '.kortix/opencode/skills/system/references/opencode/rules.md',
  '.kortix/opencode/skills/system/references/opencode/skills.md',
  '.kortix/opencode/skills/system/references/opencode/tools.md',
...
describe('create-repo starter scaffold contract', () => {
  ...
  test('builds exactly the minimal starter scaffold', () => {
    ...
    expect(files.find((file) => file.path === '.kortix/opencode/skills/system/SKILL.md')).toBeDefined();
